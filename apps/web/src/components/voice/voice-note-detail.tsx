...
export function VoiceNoteDetail({ id }: { id: string }) {
  return (
    <div className="grid gap-4">
      <section aria-labelledby="voice-note-title" className="rounded-md border border-line bg-panel p-4">
        ...
        <h2 id="voice-note-title" className="mt-2 text-2xl font-semibold text-ink">
          Sprint 8 Voice Note {id}
        </h2>
        <p className="mt-2 text-sm leading-6 text-slate-600">
          Audio processing is represented by metadata and transcript placeholders only.
        </p>
      </section>
      ...
      <TranscriptPanel
        ...
        text="Placeholder transcript. Human review is required before a task draft can be confirmed."
      />
      <AIPlaceholderNotice />
