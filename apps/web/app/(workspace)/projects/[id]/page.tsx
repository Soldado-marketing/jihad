...
type Project = { id: string; name: string; status: string; description?: string; tasks?: Task[]; _count?: { tasks: number } };
...
export default function ProjectDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader eyebrow="Projects" title={project.name} description={project.description ?? project.status}
        actions={
